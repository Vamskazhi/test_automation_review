...
from tests.helpers.data_tests import created_dict, fake_call
...
@pytest.mark.parametrize(
    ...
    [
        ...
        {
            (101, 1): fake_call("word"),
            (1, 2): fake_call("word"),
            (0,): fake_call("word"),
        },
    ],
    ids=["Empty dictionary", "Integer keys", "UUID4 keys", "Tuple keys"],
)
...
@pytest.mark.parametrize(
    ...
    ids=["None input", "List input", "Mixed key types"],
)
